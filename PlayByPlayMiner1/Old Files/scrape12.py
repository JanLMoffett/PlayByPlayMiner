...
class PlayByPlay:
    ...
    def sep_substitutions(self): #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        num_substitutions = self.original_pbp_string.count("for")
        
        
        #return empty list and unchanged string if there are no substitutions in hi
        if num_substitutions == 0:
            return (self.original_pbp_string, subn_strings)
        ...
        for i in range(num_substitutions):
            ...
            #add to string where subns are removed
            new_pbp += (t[:a])
...
def main():    
    ...
    print("Away Play by Play String 0:")
    print(away_pbps[0])
    print()
